...
// We can safely reuse the Broadsheets CSS since it provides the exact layout requested
import "../../../grading/components/Broadsheets/Broadsheets.css";
  ...
  if (isLoading) {
    return (
      <div className="broadsheets-layout" style={{ justifyContent: 'center', alignItems: 'center' }}>
        <div className="loading-dense">Synchronizing attendance records...</div>
      </div>
    );
  }
      ...
      <main className="broadsheets-main">
        {selectedArm ? (
          ...
          <div className="broadsheets-empty-state">
            ...
            <h3 className="selection-title">Class Attendance</h3>
            <p className="selection-desc">
              Please select a class arm from the sidebar to load the attendance sheet.
            </p>
          </div>
        )}
      </main>
